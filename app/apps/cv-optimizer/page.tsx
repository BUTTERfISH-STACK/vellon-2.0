...
Experienced software developer with expertise in web technologies and team leadership.
...
This CV has been optimized with keyword suggestions for better ATS compatibility.
                ...
                {showResult && resultData && (
                  <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6">
                      ...
                      <div className="aspect-[3/4] bg-white dark:bg-gray-600 rounded border border-gray-200 dark:border-gray-500 p-4 mb-4 overflow-hidden">
                        <div className="text-gray-900 dark:text-white text-xs leading-tight">
                          ...
                          <div className="mb-2">
                            <h4 className="font-semibold text-xs mb-1">CONTACT</h4>
