    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <section className="text-center py-24">
          <h1 className="text-5xl sm:text-6xl font-bold mb-8">Your Career Starts Here</h1>
          <p className="max-w-4xl mx-auto text-xl text-text-muted mb-12">Professional CV tools designed to help South Africans land their dream jobs</p>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-surface rounded-2xl p-10 border border-border">
              ...
              <p className="text-text-muted mb-8 leading-relaxed text-lg">
                Transform your CV to beat ATS systems and get noticed by South African employers. Stand out from the competition with professionally optimized content.
              </p>
            ...
            <div className="bg-surface rounded-2xl p-10 border border-border">
              ...
              <p className="text-text-muted mb-8 leading-relaxed text-lg">
                Give your career a fresh start with modern CV designs that impress South African employers. Showcase your skills and experience in the best possible light.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="/apps/cv-redo"
