...
export default function AppsPage() {
  ...
  const tools = [
    ...
    },
    {
      ...
      description: 'End-to-end job application service with CV optimization, job sourcing, and application preparation',
      longDescription: 'Get a complete job application sprint: CV optimization, targeted job sourcing from approved platforms, custom cover letters, and human-in-the-loop submission support.',
      href: '/apps/job-application-sprint',
      icon: '🚀',
      color: 'bg-orange-500',
      category: 'job',
      features: ['CV Optimization', 'Job Sourcing', 'Application Prep', 'Submission Support'],
      new: true
    },
    {
      id: 'career-planner',
