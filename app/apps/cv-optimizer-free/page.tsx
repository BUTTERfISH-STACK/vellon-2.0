...
export default function CVOptimizerFreePage() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      img.src = '/WhatsApp_Image_2026-01-19_at_10.34.05_AM-removebg-preview.png';
      ...
      doc.addImage(img, 'PNG', (doc.internal.pageSize.getWidth() - imgWidth) / 2, (doc.internal.pageSize.getHeight() - imgHeight) / 2, imgWidth, imgHeight, undefined, 'FAST');
    } catch (error) {
